...
public class wayPointMaker : MonoBehaviour
{
    ...
    void Start() {
        // Pick the right waypoint if the player is in the hub world
        if (SceneManager.GetActiveScene().name == "HubWorld") { 
            target = GameObject.Find("/LevelPortals/LevelPortal_Level" + LevelManager.instance.GetCurrentLevel()).transform;
        }
    ...
    public void ChooseCorrectHubWorldTarget() {
